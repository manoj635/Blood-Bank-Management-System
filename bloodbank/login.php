...
<body>
  <?php require 'header.php'; ?>
    ...
    <div class="container cont">
      ...
      <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#hospitals Admin">Hospitals Admin</a>
      </li>
     <li class="nav-item">
    ...
    <div class="tab-content">
       <div class="tab-pane container active" id="hospitals Admin">
        <form action="file/hospitalLogin.php" method="post">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Hospital Admin Email</label>
          <input type="email" name="hemail" placeholder="Hospital Admin Email" class="form-control mb-4">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Hospital Admin Password</label>
          <input type="password" name="hpassword" placeholder="Hospital Admin Password" class="form-control mb-4">
