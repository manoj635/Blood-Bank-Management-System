<nav class="navbar navbar-expand-sm navbar-light bg-black sticky-top">
	<div class="container">
		<a class="navbar-brand" href="index.php"><img src="image/favicon.jpg" width="30" height="30" class="rounded-circle">Lifeline Blood Bank</a>
		...
		<ul class="navbar-nav ml-auto ">
			<li class="nav-item">
				<a class="nav-link btn btn-black" href="bloodinfo.php">Add Blood Info</a>
            </li>
            <li class="nav-item">
                <a class="nav-link btn btn-black" href="bloodrequest.php">Blood Request</a>
            </li>
			<li class="nav-item">
				<a class="nav-link btn btn-black" href="abs.php">Available Blood Samples</a>
            </li>
            <li class="nav-item">
